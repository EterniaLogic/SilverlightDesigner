...
namespace Silverlight_Designer
{
    partial class AboutBox1 : Form
    {
        public AboutBox1()
        {
            ...
            labelVersion.Text = "Version "+Silverlight_Designer.start.INF.Version;
        }
        ...
        private void AboutBox1_Paint(object sender, PaintEventArgs e)
        {
            Color[] Colors1 = new Color[]{Color.DarkRed,
                                            Color.Red,
                                            Color.DarkOrange};

            ColorBlend mycolor = new ColorBlend();
            mycolor.Colors = Colors1;
            mycolor.Positions = positions1;
